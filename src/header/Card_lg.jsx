  ...
  return (
    <>
      <div className='img relative h-72'>
        ...
        <div className='overlay icon absolute top-1/4 left-[45%] text-white '>
          <BsPlayCircle size={85} className='show' />
          <AiFillPlayCircle size={80} className='hide absolute -top-1 -left-1' />
        </div>
